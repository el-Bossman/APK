...
@Component({
  selector: 'app-tipo2',
  templateUrl: './tipo2.page.html',
  styleUrls: ['./tipo2.page.scss'],
})
export class Tipo2Page implements OnInit {
  constructor(public toastctrl : ToastController, public navCntrl : NavController, public ActivatedRoute: ActivatedRoute, public alertCtrl: AlertController, public ASheetCtrl : ActionSheetController) {}
  ...
  async ngOnInit() {
   ...
   const alert = await this.alertCtrl.create({
    header: 'Bienvenido, Selecciona el figura que corresponda a la imagen.',
    message: 
